...
3. [Problems](src/_2_problems)
    ...
    51. [Self Referential Queries](src/_2_problems/_2_51_self_referential_queries)
        ...
        3. [Problem 53: Get all employees that have manager or does not have manager along with Manager's name, incase no manager name the same manager name as employee name to himself](src/_2_problems/_2_51_self_referential_queries/_2_51_3_get_all_employees_that_have_manager_or_does_not_have_manager_along_with_managers_name_and_incase_no_manager_name_the_same_manager_name_as_employee_name_to_himself)
        4. [Problem 54: Get All Employees managed by 'Mohammed'](src/_2_problems/_2_51_self_referential_queries/_2_51_4_get_all_employees_managed_by_mohammed)